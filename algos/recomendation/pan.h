...
#define PanSource	"concurrente.pml"
...
#define _nstates2	27	/* Consumer */
#define minseq2	32
#define maxseq2	57
#define _endstate2	26

#define _nstates1	14	/* Worker */
#define minseq1	19
#define maxseq1	31
#define _endstate1	13

#define _nstates0	20	/* Feeder */
#define minseq0	0
#define maxseq0	18
...
#define Air3	(sizeof(P3) - Offsetof(P3, w) - 1*sizeof(int))

#define PConsumer	((P2 *)_this)
typedef struct P2 { /* Consumer */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, idx) - 1*sizeof(int))
...
#define Air1	(sizeof(P1) - Offsetof(P1, idx) - 1*sizeof(int))

#define PFeeder	((P0 *)_this)
typedef struct P0 { /* Feeder */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, k) - 1*sizeof(int))
